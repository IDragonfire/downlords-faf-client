...
public class CoopController {
  ...
  private static final Predicate<Game> OPEN_COOP_GAMES_PREDICATE = gameInfoBean ->
      gameInfoBean.getStatus() == GameState.OPEN
          && GameType.COOP.getString().equals(gameInfoBean.getFeaturedMod());
  ...
  @PostConstruct
  void postConstruct() {
    Platform.runLater(() -> JavaFxUtil.configureWebView(descriptionWebView, preferencesService, themeService));
  ...
  public void onPlayButtonClicked() {
    gameService.hostGame(new NewGameInfo(titleTextField.getText(), Strings.emptyToNull(passwordTextField.getText()),
        COOP.getString(), getSelectedMission().getMapFolderName(), emptySet()));
  }
